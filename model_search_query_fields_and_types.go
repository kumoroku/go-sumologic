...
func NewSearchQueryFieldsAndTypes() *SearchQueryFieldsAndTypes {
	this := SearchQueryFieldsAndTypes{}
	return &this
}
...
type NullableSearchQueryFieldsAndTypes struct {
	value *SearchQueryFieldsAndTypes
	isSet bool
}

func (v NullableSearchQueryFieldsAndTypes) Get() *SearchQueryFieldsAndTypes {
	return v.value
}

func (v *NullableSearchQueryFieldsAndTypes) Set(val *SearchQueryFieldsAndTypes) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchQueryFieldsAndTypes) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchQueryFieldsAndTypes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchQueryFieldsAndTypes(val *SearchQueryFieldsAndTypes) *NullableSearchQueryFieldsAndTypes {
	return &NullableSearchQueryFieldsAndTypes{value: val, isSet: true}
}
