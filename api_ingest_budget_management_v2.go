...
func (r ApiCreateIngestBudgetV2Request) Execute() (IngestBudgetV2, *_nethttp.Response, error) {
...
*/
func (a *IngestBudgetManagementV2ApiService) CreateIngestBudgetV2(ctx _context.Context) ApiCreateIngestBudgetV2Request {
	return ApiCreateIngestBudgetV2Request{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *IngestBudgetManagementV2ApiService) CreateIngestBudgetV2Execute(r ApiCreateIngestBudgetV2Request) (IngestBudgetV2, *_nethttp.Response, error) {
	var (
...
func (r ApiDeleteIngestBudgetV2Request) Execute() (*_nethttp.Response, error) {
...
*/
func (a *IngestBudgetManagementV2ApiService) DeleteIngestBudgetV2(ctx _context.Context, id string) ApiDeleteIngestBudgetV2Request {
	return ApiDeleteIngestBudgetV2Request{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *IngestBudgetManagementV2ApiService) DeleteIngestBudgetV2Execute(r ApiDeleteIngestBudgetV2Request) (*_nethttp.Response, error) {
	var (
...
func (r ApiGetIngestBudgetV2Request) Execute() (IngestBudgetV2, *_nethttp.Response, error) {
...
*/
func (a *IngestBudgetManagementV2ApiService) GetIngestBudgetV2(ctx _context.Context, id string) ApiGetIngestBudgetV2Request {
	return ApiGetIngestBudgetV2Request{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return IngestBudgetV2
func (a *IngestBudgetManagementV2ApiService) GetIngestBudgetV2Execute(r ApiGetIngestBudgetV2Request) (IngestBudgetV2, *_nethttp.Response, error) {
	var (
...
func (r ApiListIngestBudgetsV2Request) Execute() (ListIngestBudgetsResponseV2, *_nethttp.Response, error) {
...
*/
func (a *IngestBudgetManagementV2ApiService) ListIngestBudgetsV2(ctx _context.Context) ApiListIngestBudgetsV2Request {
	return ApiListIngestBudgetsV2Request{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *IngestBudgetManagementV2ApiService) ListIngestBudgetsV2Execute(r ApiListIngestBudgetsV2Request) (ListIngestBudgetsResponseV2, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiResetUsageV2Request) Execute() (*_nethttp.Response, error) {
...
*/
func (a *IngestBudgetManagementV2ApiService) ResetUsageV2(ctx _context.Context, id string) ApiResetUsageV2Request {
	return ApiResetUsageV2Request{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *IngestBudgetManagementV2ApiService) ResetUsageV2Execute(r ApiResetUsageV2Request) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiUpdateIngestBudgetV2Request) Execute() (IngestBudgetV2, *_nethttp.Response, error) {
...
*/
func (a *IngestBudgetManagementV2ApiService) UpdateIngestBudgetV2(ctx _context.Context, id string) ApiUpdateIngestBudgetV2Request {
	return ApiUpdateIngestBudgetV2Request{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return IngestBudgetV2
func (a *IngestBudgetManagementV2ApiService) UpdateIngestBudgetV2Execute(r ApiUpdateIngestBudgetV2Request) (IngestBudgetV2, *_nethttp.Response, error) {
	var (
