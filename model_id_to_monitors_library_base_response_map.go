...
func NewIdToMonitorsLibraryBaseResponseMap() *IdToMonitorsLibraryBaseResponseMap {
	this := IdToMonitorsLibraryBaseResponseMap{}
	return &this
}
...
type NullableIdToMonitorsLibraryBaseResponseMap struct {
	value *IdToMonitorsLibraryBaseResponseMap
	isSet bool
}

func (v NullableIdToMonitorsLibraryBaseResponseMap) Get() *IdToMonitorsLibraryBaseResponseMap {
	return v.value
}

func (v *NullableIdToMonitorsLibraryBaseResponseMap) Set(val *IdToMonitorsLibraryBaseResponseMap) {
	v.value = val
	v.isSet = true
}

func (v NullableIdToMonitorsLibraryBaseResponseMap) IsSet() bool {
	return v.isSet
}

func (v *NullableIdToMonitorsLibraryBaseResponseMap) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdToMonitorsLibraryBaseResponseMap(val *IdToMonitorsLibraryBaseResponseMap) *NullableIdToMonitorsLibraryBaseResponseMap {
	return &NullableIdToMonitorsLibraryBaseResponseMap{value: val, isSet: true}
}

func (v NullableIdToMonitorsLibraryBaseResponseMap) MarshalJSON() ([]byte, error) {
