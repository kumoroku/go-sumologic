...
func (o *MewboardSyncDefinitionAllOf) GetRootPanel() ContainerPanel {
	if o == nil || o.RootPanel == nil {
		var ret ContainerPanel
		return ret
	}
	return *o.RootPanel
}

// GetRootPanelOk returns a tuple with the RootPanel field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MewboardSyncDefinitionAllOf) GetRootPanelOk() (*ContainerPanel, bool) {
	if o == nil || o.RootPanel == nil {
		return nil, false
	}
	return o.RootPanel, true
}
...
func (o MewboardSyncDefinitionAllOf) MarshalJSON() ([]byte, error) {
	...
	if o.RootPanel != nil {
		toSerialize["rootPanel"] = o.RootPanel
	}
	if o.Theme != nil {
