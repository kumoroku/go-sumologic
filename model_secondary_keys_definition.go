...
type NullableSecondaryKeysDefinition struct {
	value *SecondaryKeysDefinition
	isSet bool
}

func (v NullableSecondaryKeysDefinition) Get() *SecondaryKeysDefinition {
	return v.value
}

func (v *NullableSecondaryKeysDefinition) Set(val *SecondaryKeysDefinition) {
	v.value = val
	v.isSet = true
}

func (v NullableSecondaryKeysDefinition) IsSet() bool {
	return v.isSet
}

func (v *NullableSecondaryKeysDefinition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecondaryKeysDefinition(val *SecondaryKeysDefinition) *NullableSecondaryKeysDefinition {
	return &NullableSecondaryKeysDefinition{value: val, isSet: true}
}
