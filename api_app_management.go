...
*/
func (a *AppManagementApiService) GetApp(ctx _context.Context, uuid string) ApiGetAppRequest {
	return ApiGetAppRequest{
		ApiService: a,
		ctx: ctx,
		uuid: uuid,
...
//  @return App
func (a *AppManagementApiService) GetAppExecute(r ApiGetAppRequest) (App, *_nethttp.Response, error) {
	var (
...
func (r ApiGetAsyncInstallStatusRequest) Execute() (AsyncJobStatus, *_nethttp.Response, error) {
...
func (a *AppManagementApiService) GetAsyncInstallStatusExecute(r ApiGetAsyncInstallStatusRequest) (AsyncJobStatus, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiInstallAppRequest) Execute() (BeginAsyncJobResponse, *_nethttp.Response, error) {
...
*/
func (a *AppManagementApiService) InstallApp(ctx _context.Context, uuid string) ApiInstallAppRequest {
	return ApiInstallAppRequest{
		ApiService: a,
		ctx: ctx,
		uuid: uuid,
...
func (a *AppManagementApiService) InstallAppExecute(r ApiInstallAppRequest) (BeginAsyncJobResponse, *_nethttp.Response, error) {
	var (
...
func (r ApiListAppsRequest) Execute() (ListAppsResult, *_nethttp.Response, error) {
...
*/
func (a *AppManagementApiService) ListApps(ctx _context.Context) ApiListAppsRequest {
	return ApiListAppsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AppManagementApiService) ListAppsExecute(r ApiListAppsRequest) (ListAppsResult, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
