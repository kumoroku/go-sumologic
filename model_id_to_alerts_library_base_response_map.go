...
func NewIdToAlertsLibraryBaseResponseMap() *IdToAlertsLibraryBaseResponseMap {
	this := IdToAlertsLibraryBaseResponseMap{}
	return &this
}
...
type NullableIdToAlertsLibraryBaseResponseMap struct {
	value *IdToAlertsLibraryBaseResponseMap
	isSet bool
}

func (v NullableIdToAlertsLibraryBaseResponseMap) Get() *IdToAlertsLibraryBaseResponseMap {
	return v.value
}

func (v *NullableIdToAlertsLibraryBaseResponseMap) Set(val *IdToAlertsLibraryBaseResponseMap) {
	v.value = val
	v.isSet = true
}

func (v NullableIdToAlertsLibraryBaseResponseMap) IsSet() bool {
	return v.isSet
}

func (v *NullableIdToAlertsLibraryBaseResponseMap) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdToAlertsLibraryBaseResponseMap(val *IdToAlertsLibraryBaseResponseMap) *NullableIdToAlertsLibraryBaseResponseMap {
	return &NullableIdToAlertsLibraryBaseResponseMap{value: val, isSet: true}
}

func (v NullableIdToAlertsLibraryBaseResponseMap) MarshalJSON() ([]byte, error) {
