...
func (r ApiCreateConnectionRequest) Execute() (Connection, *_nethttp.Response, error) {
...
*/
func (a *ConnectionManagementApiService) CreateConnection(ctx _context.Context) ApiCreateConnectionRequest {
	return ApiCreateConnectionRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return Connection
func (a *ConnectionManagementApiService) CreateConnectionExecute(r ApiCreateConnectionRequest) (Connection, *_nethttp.Response, error) {
	var (
...
*/
func (a *ConnectionManagementApiService) DeleteConnection(ctx _context.Context, id string) ApiDeleteConnectionRequest {
	return ApiDeleteConnectionRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *ConnectionManagementApiService) DeleteConnectionExecute(r ApiDeleteConnectionRequest) (*_nethttp.Response, error) {
	var (
...
*/
func (a *ConnectionManagementApiService) GetConnection(ctx _context.Context, id string) ApiGetConnectionRequest {
	return ApiGetConnectionRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return Connection
func (a *ConnectionManagementApiService) GetConnectionExecute(r ApiGetConnectionRequest) (Connection, *_nethttp.Response, error) {
	var (
...
func (r ApiListConnectionsRequest) Execute() (ListConnectionsResponse, *_nethttp.Response, error) {
...
*/
func (a *ConnectionManagementApiService) ListConnections(ctx _context.Context) ApiListConnectionsRequest {
	return ApiListConnectionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ConnectionManagementApiService) ListConnectionsExecute(r ApiListConnectionsRequest) (ListConnectionsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiTestConnectionRequest) Execute() (TestConnectionResponse, *_nethttp.Response, error) {
...
*/
func (a *ConnectionManagementApiService) TestConnection(ctx _context.Context) ApiTestConnectionRequest {
	return ApiTestConnectionRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ConnectionManagementApiService) TestConnectionExecute(r ApiTestConnectionRequest) (TestConnectionResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiUpdateConnectionRequest) Execute() (Connection, *_nethttp.Response, error) {
...
*/
func (a *ConnectionManagementApiService) UpdateConnection(ctx _context.Context, id string) ApiUpdateConnectionRequest {
	return ApiUpdateConnectionRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return Connection
func (a *ConnectionManagementApiService) UpdateConnectionExecute(r ApiUpdateConnectionRequest) (Connection, *_nethttp.Response, error) {
	var (
