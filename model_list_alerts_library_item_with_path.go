...
func NewListAlertsLibraryItemWithPath() *ListAlertsLibraryItemWithPath {
	this := ListAlertsLibraryItemWithPath{}
	return &this
}
...
type NullableListAlertsLibraryItemWithPath struct {
	value *ListAlertsLibraryItemWithPath
	isSet bool
}

func (v NullableListAlertsLibraryItemWithPath) Get() *ListAlertsLibraryItemWithPath {
	return v.value
}

func (v *NullableListAlertsLibraryItemWithPath) Set(val *ListAlertsLibraryItemWithPath) {
	v.value = val
	v.isSet = true
}

func (v NullableListAlertsLibraryItemWithPath) IsSet() bool {
	return v.isSet
}

func (v *NullableListAlertsLibraryItemWithPath) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAlertsLibraryItemWithPath(val *ListAlertsLibraryItemWithPath) *NullableListAlertsLibraryItemWithPath {
	return &NullableListAlertsLibraryItemWithPath{value: val, isSet: true}
}
