...
func (r ApiGetLogSearchEstimatedUsageRequest) Execute() (LogSearchEstimatedUsageDefinition, *_nethttp.Response, error) {
...
*/
func (a *LogSearchesEstimatedUsageApiService) GetLogSearchEstimatedUsage(ctx _context.Context) ApiGetLogSearchEstimatedUsageRequest {
	return ApiGetLogSearchEstimatedUsageRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *LogSearchesEstimatedUsageApiService) GetLogSearchEstimatedUsageExecute(r ApiGetLogSearchEstimatedUsageRequest) (LogSearchEstimatedUsageDefinition, *_nethttp.Response, error) {
	var (
...
func (r ApiGetLogSearchEstimatedUsageByTierRequest) Execute() (LogSearchEstimatedUsageByTierDefinition, *_nethttp.Response, error) {
...
*/
func (a *LogSearchesEstimatedUsageApiService) GetLogSearchEstimatedUsageByTier(ctx _context.Context) ApiGetLogSearchEstimatedUsageByTierRequest {
	return ApiGetLogSearchEstimatedUsageByTierRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *LogSearchesEstimatedUsageApiService) GetLogSearchEstimatedUsageByTierExecute(r ApiGetLogSearchEstimatedUsageByTierRequest) (LogSearchEstimatedUsageByTierDefinition, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
