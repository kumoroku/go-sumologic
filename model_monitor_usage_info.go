...
type NullableMonitorUsageInfo struct {
	value *MonitorUsageInfo
	isSet bool
}

func (v NullableMonitorUsageInfo) Get() *MonitorUsageInfo {
	return v.value
}

func (v *NullableMonitorUsageInfo) Set(val *MonitorUsageInfo) {
	v.value = val
	v.isSet = true
}
...
func NewNullableMonitorUsageInfo(val *MonitorUsageInfo) *NullableMonitorUsageInfo {
	return &NullableMonitorUsageInfo{value: val, isSet: true}
}
