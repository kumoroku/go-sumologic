...
type NullableContainerPanelAllOf struct {
	value *ContainerPanelAllOf
	isSet bool
}

func (v NullableContainerPanelAllOf) Get() *ContainerPanelAllOf {
	return v.value
}

func (v *NullableContainerPanelAllOf) Set(val *ContainerPanelAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableContainerPanelAllOf) IsSet() bool {
	return v.isSet
}
...
func NewNullableContainerPanelAllOf(val *ContainerPanelAllOf) *NullableContainerPanelAllOf {
	return &NullableContainerPanelAllOf{value: val, isSet: true}
}
