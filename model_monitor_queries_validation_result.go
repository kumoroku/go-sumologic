...
func NewMonitorQueriesValidationResult() *MonitorQueriesValidationResult {
	this := MonitorQueriesValidationResult{}
	var message string = ""
...
type NullableMonitorQueriesValidationResult struct {
	value *MonitorQueriesValidationResult
	isSet bool
}

func (v NullableMonitorQueriesValidationResult) Get() *MonitorQueriesValidationResult {
	return v.value
}

func (v *NullableMonitorQueriesValidationResult) Set(val *MonitorQueriesValidationResult) {
	v.value = val
	v.isSet = true
}

func (v NullableMonitorQueriesValidationResult) IsSet() bool {
	return v.isSet
}

func (v *NullableMonitorQueriesValidationResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonitorQueriesValidationResult(val *MonitorQueriesValidationResult) *NullableMonitorQueriesValidationResult {
	return &NullableMonitorQueriesValidationResult{value: val, isSet: true}
}
