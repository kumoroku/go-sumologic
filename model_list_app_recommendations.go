...
type NullableListAppRecommendations struct {
	value *ListAppRecommendations
	isSet bool
}

func (v NullableListAppRecommendations) Get() *ListAppRecommendations {
	return v.value
}

func (v *NullableListAppRecommendations) Set(val *ListAppRecommendations) {
	v.value = val
	v.isSet = true
}

func (v NullableListAppRecommendations) IsSet() bool {
	return v.isSet
}
...
func NewNullableListAppRecommendations(val *ListAppRecommendations) *NullableListAppRecommendations {
	return &NullableListAppRecommendations{value: val, isSet: true}
}
