...
func NewListAlertsLibraryAlertResponse() *ListAlertsLibraryAlertResponse {
	this := ListAlertsLibraryAlertResponse{}
	return &this
}
...
type NullableListAlertsLibraryAlertResponse struct {
	value *ListAlertsLibraryAlertResponse
	isSet bool
}

func (v NullableListAlertsLibraryAlertResponse) Get() *ListAlertsLibraryAlertResponse {
	return v.value
}

func (v *NullableListAlertsLibraryAlertResponse) Set(val *ListAlertsLibraryAlertResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListAlertsLibraryAlertResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListAlertsLibraryAlertResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAlertsLibraryAlertResponse(val *ListAlertsLibraryAlertResponse) *NullableListAlertsLibraryAlertResponse {
	return &NullableListAlertsLibraryAlertResponse{value: val, isSet: true}
}
