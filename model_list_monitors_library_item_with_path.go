...
func NewListMonitorsLibraryItemWithPath() *ListMonitorsLibraryItemWithPath {
	this := ListMonitorsLibraryItemWithPath{}
	return &this
}
...
type NullableListMonitorsLibraryItemWithPath struct {
	value *ListMonitorsLibraryItemWithPath
	isSet bool
}

func (v NullableListMonitorsLibraryItemWithPath) Get() *ListMonitorsLibraryItemWithPath {
	return v.value
}

func (v *NullableListMonitorsLibraryItemWithPath) Set(val *ListMonitorsLibraryItemWithPath) {
	v.value = val
	v.isSet = true
}

func (v NullableListMonitorsLibraryItemWithPath) IsSet() bool {
	return v.isSet
}

func (v *NullableListMonitorsLibraryItemWithPath) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListMonitorsLibraryItemWithPath(val *ListMonitorsLibraryItemWithPath) *NullableListMonitorsLibraryItemWithPath {
	return &NullableListMonitorsLibraryItemWithPath{value: val, isSet: true}
}
