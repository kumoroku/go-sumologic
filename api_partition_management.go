...
func (r ApiCancelRetentionUpdateRequest) Execute() (*_nethttp.Response, error) {
...
*/
func (a *PartitionManagementApiService) CancelRetentionUpdate(ctx _context.Context, id string) ApiCancelRetentionUpdateRequest {
	return ApiCancelRetentionUpdateRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *PartitionManagementApiService) CancelRetentionUpdateExecute(r ApiCancelRetentionUpdateRequest) (*_nethttp.Response, error) {
	var (
...
func (r ApiCreatePartitionRequest) Execute() (Partition, *_nethttp.Response, error) {
...
*/
func (a *PartitionManagementApiService) CreatePartition(ctx _context.Context) ApiCreatePartitionRequest {
	return ApiCreatePartitionRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return Partition
func (a *PartitionManagementApiService) CreatePartitionExecute(r ApiCreatePartitionRequest) (Partition, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiDecommissionPartitionRequest) Execute() (*_nethttp.Response, error) {
...
*/
func (a *PartitionManagementApiService) DecommissionPartition(ctx _context.Context, id string) ApiDecommissionPartitionRequest {
	return ApiDecommissionPartitionRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *PartitionManagementApiService) DecommissionPartitionExecute(r ApiDecommissionPartitionRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGetPartitionRequest) Execute() (Partition, *_nethttp.Response, error) {
...
*/
func (a *PartitionManagementApiService) GetPartition(ctx _context.Context, id string) ApiGetPartitionRequest {
	return ApiGetPartitionRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return Partition
func (a *PartitionManagementApiService) GetPartitionExecute(r ApiGetPartitionRequest) (Partition, *_nethttp.Response, error) {
	var (
...
func (r ApiListPartitionsRequest) Execute() (ListPartitionsResponse, *_nethttp.Response, error) {
...
*/
func (a *PartitionManagementApiService) ListPartitions(ctx _context.Context) ApiListPartitionsRequest {
	return ApiListPartitionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *PartitionManagementApiService) ListPartitionsExecute(r ApiListPartitionsRequest) (ListPartitionsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiUpdatePartitionRequest) Execute() (Partition, *_nethttp.Response, error) {
...
*/
func (a *PartitionManagementApiService) UpdatePartition(ctx _context.Context, id string) ApiUpdatePartitionRequest {
	return ApiUpdatePartitionRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return Partition
func (a *PartitionManagementApiService) UpdatePartitionExecute(r ApiUpdatePartitionRequest) (Partition, *_nethttp.Response, error) {
	var (
