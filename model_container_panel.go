...
type NullableContainerPanel struct {
	value *ContainerPanel
	isSet bool
}

func (v NullableContainerPanel) Get() *ContainerPanel {
	return v.value
}

func (v *NullableContainerPanel) Set(val *ContainerPanel) {
	v.value = val
	v.isSet = true
}
...
func NewNullableContainerPanel(val *ContainerPanel) *NullableContainerPanel {
	return &NullableContainerPanel{value: val, isSet: true}
}
